...
export function AgentStatusBanner() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-atomic="true"
      className="mt-3 flex items-center gap-3 rounded-xl border-2 border-[var(--color-depth)] bg-[var(--color-deck)] p-4 text-[18px] text-[var(--color-depth)] shadow-[var(--shadow-elevation)] transition-opacity duration-200 motion-reduce:transition-none"
    >
