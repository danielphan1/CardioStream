...
- [x] **GUIDE-01**: A static, always-available guide tab explains every control, filter, chart, and upload flow on the site — for both Chris and caregivers
...
- [x] **GUIDE-03**: Guide is reachable and usable without unmounting the live voice session (rendered inside the dashboard's component tree, not as a view-swap that would kill the recognizer)
- [x] **GUIDE-04**: Guide meets the same accessibility bar as the rest of the site (≥48px targets, ≥18px text, high contrast, keyboard + voice navigable)
...
| GUIDE-01 | Phase 11: Full Site Guide / Instructions Tab | Complete |
