...
- [ ] 04-02-PLAN.md — useVoiceCommand hook: singleton recognizer lifecycle, onend/onerror restart loop with backoff, wake-word gating, newest-wins seq guard (reuses /agent unchanged)
